...
public class cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTUser, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
        ...
        jMAtualizar.setText("ATUALIZAR");
        jMAtualizar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMAtualizarActionPerformed(evt);
            }
        });
        jMOpcoes.add(jMAtualizar);
    ...
    private void jMAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMAtualizarActionPerformed
        // TODO add your handling code here:
        update up = new update();
        up.setVisible(true);
        this.dispose();
        
    }//GEN-LAST:event_jMAtualizarActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(this.jTNome.getText().isEmpty() || this.jTUser.getText().isEmpty() || this.jPass.getText().isEmpty() || this.jTEnd.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha todos os Campos", "Alerta", JOptionPane.WARNING_MESSAGE);
        } else {
            funcionario funcio = new funcionario();
            funcio.setNome(this.jTNome.getText());
            funcio.setUsuario(this.jTUser.getText());
            String senha;
            senha = String.valueOf(jPass.getPassword());
            funcio.setSenha(senha);
            funcio.setEndereco(this.jTEnd.getText());
    ...
    private javax.swing.JMenuItem jMAtualizar;
